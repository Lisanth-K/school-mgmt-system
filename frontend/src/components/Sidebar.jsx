...
import { Calendar, BookOpen, Users, Layers, GraduationCap, ClipboardList, Book, Settings, User } from 'lucide-react';
    ...
    <div className="sidebar">
      ...
      <div className="sidebar-profile">
        <div className="profile-icon">
          {/* Changed color to dark navy to match the white circle theme */}
